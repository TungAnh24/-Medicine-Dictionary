 ...
 */
public class CreateEngView extends javax.swing.JFrame {

    /**
     * Creates new form createVie
     */
    DbConnect conn = new DbConnect();
    EngController engController = new EngController();

    public CreateEngView() throws SQLException {
        initComponents();
        loadCombobox();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add new specialized terms");
        ...
        jButton2.setIcon(new javax.swing.ImageIcon("E:\\HocJava_DNU\\DictPharacy\\src\\main\\java\\com\\icon\\cancel.png")); // NOI18N
        ...
        jButton1.setIcon(new javax.swing.ImageIcon("E:\\HocJava_DNU\\DictPharacy\\src\\main\\java\\com\\icon\\add-file.png")); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (word == "^([A-Z])\\w{3}$") {
            JOptionPane.showMessageDialog(null, "Term must be capitalized first word and be 3 or more characters.", "Notify", JOptionPane.ERROR_MESSAGE);
        } else if (sltItemcbb == -1) {
            JOptionPane.showMessageDialog(null, "You have not selected a word type", "Notify", JOptionPane.WARNING_MESSAGE);
        } else {
            if (engController.addEng(word, wordtype, des)) {
                JOptionPane.showMessageDialog(null, "'" + word + "' " + "terminology create success");
                this.dispose();
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreateEngView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new CreateEngView().setVisible(true);
                } catch (SQLException ex) {
                    System.out.println(ex.getMessage());
                }
            }
